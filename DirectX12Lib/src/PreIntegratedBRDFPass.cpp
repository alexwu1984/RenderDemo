...
FPreIntegratedBRDFPass::FPreIntegratedBRDFPass()
{
...
void FPreIntegratedBRDFPass::Init()
{
	SetupRootSignature();
...
void FPreIntegratedBRDFPass::IntegrateBRDF(FColorBuffer& target)
{
...
void FPreIntegratedBRDFPass::SetupRootSignature()
{
...
void FPreIntegratedBRDFPass::SetupPipelineState(const std::wstring& ShaderFile, const std::string& entryVSPoint, const std::string& entryPSPoint)
{
