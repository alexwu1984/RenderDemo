...
void ImguiManager::Initialize()
{
	...
	m_ImGUIVS = D3D12RHI::Get().CreateShader(ApplicationWin32::Get().GetCurrentWorkPath()+ L"Resources/Shaders/ImGUI.hlsl", "VS_Main", "vs_5_1");
	m_ImGUIPS = D3D12RHI::Get().CreateShader(ApplicationWin32::Get().GetCurrentWorkPath() + L"Resources/Shaders/ImGUI.hlsl", "PS_Main", "ps_5_1");
