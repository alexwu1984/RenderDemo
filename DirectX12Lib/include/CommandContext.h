...
public:
	...
	void CopyBuffer(FD3D12Resource& Dest, FD3D12Resource& Src);
	void CopyBufferRegion(FD3D12Resource& Dest, size_t DestOffset, FD3D12Resource& Src, size_t SrcOffset, size_t NumBytes);
