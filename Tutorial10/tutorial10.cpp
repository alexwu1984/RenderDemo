...
class Tutorial10 : public FDirectLightGameMode
{

public:
	Tutorial10(const GameDesc& Desc) : FDirectLightGameMode(Desc)
	{
	}
...
int main()
{
	...
	GameDesc Desc;
	Desc.Caption = L"Tutorial10 - Image Space Horizon Based Ambient Occlusion";
